...
const LoginForm: React.FC = () => {
  ...
  return (
    <div className="w-full max-w-md mx-auto px-8 py-12 sm:p-12 animate-fadeIn" style={{ animationDelay: '500ms' }}>
      <div className="bg-gray-800/50 backdrop-blur-md rounded-xl p-8 shadow-2xl border border-blue-500/20 hover:shadow-glow hover:scale-105 transition-all duration-300">
        ...
        >
          ...
          <span className="text-sm font-medium">{isLoading ? 'Signing in...' : 'Sign in with Google'}</span>
        </Button>
        
        <div className="text-center">
          <p className="text-sm text-gray-300">
            Don't have an account? 
            <a href="/signup" className="text-blue-500 ml-1 font-medium hover:underline">
              Sign up
            </a>
          </p>
        </div>
