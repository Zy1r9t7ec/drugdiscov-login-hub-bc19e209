    ...
    <div className="app-container">
      ...
      <main className="flex-1 grid grid-cols-1 md:grid-cols-2 w-full">
        ...
        <div className="hidden md:flex flex-col justify-center items-center p-12 relative overflow-hidden animate-fade-in">
          ...
          {/* Background effect */}
          <div className="absolute top-0 left-0 right-0 bottom-0 bg-gradient-to-br from-drugdiscov-dark to-drugdiscov-dark/80"></div>
          <div className="absolute top-1/4 right-1/4 w-64 h-64 bg-drugdiscov-blue/10 rounded-full filter blur-3xl"></div>
          <div className="absolute bottom-1/4 left-1/4 w-64 h-64 bg-drugdiscov-blue/5 rounded-full filter blur-3xl"></div>
        </div>
