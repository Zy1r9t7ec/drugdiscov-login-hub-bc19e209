      ...
      <div className="flex flex-1">
        ...
        <div className="hidden lg:flex flex-col justify-center p-12 flex-1 relative">
          ...
          <div className="relative z-10 max-w-lg">
            <h1 className="mb-6">
              <span className="block text-5xl font-bold text-blue-400 mb-2">DrugDiscov</span>
        ...
        <div className="flex flex-col justify-center items-center p-6 md:p-0 flex-1 bg-gray-900">
          <LoginForm />
        </div>
      </div>
